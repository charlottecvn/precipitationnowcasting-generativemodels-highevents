...
def grid_cell_regularizer(generated_samples, batch_targets):
  loss = cityblock(generated_samples, batch_targets) #tf.reduce_mean(tf.math.abs(gen_mean - batch_targets))
  '''
  #new implementation for using balanced loss from DGMR (supplementary information)
